...
| `ck_account_password_failure_count`   | `password_failure_count BETWEEN 0 AND 5`                                                                                                             | 계좌비밀번호 연속 오류 횟수는 0회 이상 5회 이하여야 한다.                 |
| `ck_account_password_locked`          | `password_locked IN (FALSE, TRUE)`                                                                                                                   | 계좌비밀번호 잠금 여부는 Boolean 값이어야 한다.                     |
