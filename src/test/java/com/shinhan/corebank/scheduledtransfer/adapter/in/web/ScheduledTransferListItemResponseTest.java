...
class ScheduledTransferListItemResponseTest {
    ...
    void masksAccountNumbersAndName() {
        ScheduledTransferListItemResponse response =
                ScheduledTransferListItemResponse.from(item(ScheduledTransferStatus.WAITING, true));
    ...
    void cancelableReflectsItemValue() {
        ScheduledTransferListItemResponse waiting =
                ScheduledTransferListItemResponse.from(item(ScheduledTransferStatus.WAITING, true));
        ScheduledTransferListItemResponse success =
                ScheduledTransferListItemResponse.from(item(ScheduledTransferStatus.SUCCESS, false));
        ScheduledTransferListItemResponse canceled =
                ScheduledTransferListItemResponse.from(item(ScheduledTransferStatus.CANCELED, false));
