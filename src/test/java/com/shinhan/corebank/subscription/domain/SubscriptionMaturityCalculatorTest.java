...
class SubscriptionMaturityCalculatorTest {
    ...
    void deposit_cleanDivision() {
        SubscriptionMaturityCalculator.MaturityCalculation result = SubscriptionMaturityCalculator.calculate(
                ProductGroup.DEPOSIT, 6_000_000L, 12, new BigDecimal("3.70"));
    ...
    void deposit_truncatesRemainder() {
        SubscriptionMaturityCalculator.MaturityCalculation result = SubscriptionMaturityCalculator.calculate(
                ProductGroup.DEPOSIT, 1_000_000L, 5, new BigDecimal("2.00"));
    ...
    void savings_installmentWeighting() {
        SubscriptionMaturityCalculator.MaturityCalculation result = SubscriptionMaturityCalculator.calculate(
                ProductGroup.SAVINGS, 500_000L, 12, new BigDecimal("3.70"));
