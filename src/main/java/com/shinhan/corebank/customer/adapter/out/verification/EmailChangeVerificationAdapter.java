...
public class EmailChangeVerificationAdapter implements EmailChangeVerificationPort {

    private final EmailChangeVerificationTokenVerifier tokenVerifier;

    @Override
    public void verifyAndConsume(String emailVerificationToken, String email) {
        tokenVerifier.verifyAndConsumeForEmailChange(emailVerificationToken, email);
    }
}
