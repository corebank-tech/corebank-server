...
public record CustomerInfoUpdateResponse(
        ...
        @Schema(description = "마스킹된 변경 휴대폰 번호", example = "010****5678")
        String phoneNumber,

        @Schema(description = "마스킹된 변경 이메일", example = "new-****@mail.com")
        String email,

        @Schema(description = "고객정보 변경 일시", example = "2026-08-22T16:30:00+09:00")
