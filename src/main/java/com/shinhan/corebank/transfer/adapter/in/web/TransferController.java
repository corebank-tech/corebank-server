...
public class TransferController {
    ...
    public ApiResponse<TransferHistoryPageResponse> search(
            @Parameter(description = "조회할 출금계좌 ID", required = true, example = "101")
            ...
            @Parameter(description = "조회 시작일(미지정 시 종료일-1개월)", example = "2026-08-01")
    ...
    public ApiResponse<TransferHistoryDetailResponse> getDetail(
            @Parameter(description = "조회할 거래번호", required = true, example = "20260819IT0000000001")
