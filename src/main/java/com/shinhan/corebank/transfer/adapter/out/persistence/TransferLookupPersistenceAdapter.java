...
public class TransferLookupPersistenceAdapter implements TransferLookupPort {
    ...
    @Override
    public Optional<TransferResult> findBySourceAndExecutionDate(TransferSourceType sourceType, Long sourceId, LocalDate executionDate) {
        return repository.findBySourceTypeAndSourceIdAndExecutionDate(sourceType, sourceId, executionDate)
