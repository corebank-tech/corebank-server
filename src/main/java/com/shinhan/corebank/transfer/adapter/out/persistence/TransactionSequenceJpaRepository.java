...
public interface TransactionSequenceJpaRepository
        extends JpaRepository<TransactionSequenceJpaEntity, TransactionSequenceId> {
    ...
    Optional<TransactionSequenceJpaEntity> findBySeqDateAndChannelForUpdate(
            @Param("seqDate") LocalDate seqDate, @Param("channel") String channel);
}
