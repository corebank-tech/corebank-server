...
public record ScheduledTransferRegisterRequest(
        @Schema(description = "출금계좌 ID (내 계좌)", example = "1001") Long withdrawalAccountId,
        @Schema(description = "입금계좌번호 (하이픈 없이, 당행 전용)", example = "110123456789") String depositAccountNumber,
        @Schema(description = "예금주명", example = "홍길동") String payeeName,
        @Schema(description = "이체금액. 1원 이상의 정수", example = "50000", minimum = "1") Long amount,
        @Schema(description = "예약 실행일. 익일부터 1년(365일) 이내", example = "2026-09-01") LocalDate scheduledDate,
        @Schema(description = "내 통장에 남길 표시내용. 최대 10자", example = "생활비", maxLength = 10) String myPassbookMemo,
