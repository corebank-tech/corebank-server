...
public record ScheduledTransferExecutionResultSummaryResponse(
        @Schema(description = "조회 기간 내 정상처리 건수")
        long successCount,
        @Schema(description = "조회 기간 내 정상처리 금액 합계")
        long successAmount,
        @Schema(description = "조회 기간 내 오류처리 건수")
        long failureCount,
        @Schema(description = "조회 기간 내 오류처리 금액 합계")
        long failureAmount,
        @Schema(description = "조회 기간 내 취소 건수")
        long canceledCount,
        @Schema(description = "조회 기간 내 취소 금액 합계")
        long canceledAmount) {
