...
public interface ScheduledTransferPersistencePort {
    ...
    boolean existsActiveDuplicate(
            Long customerId, Long withdrawalAccountId, String payeeAccountNumber, Long amount, LocalDate scheduledDate);

    boolean claimForProcessing(Long scheduledTransferId);

    boolean saveIfStillProcessing(ScheduledTransfer scheduledTransfer);
}
