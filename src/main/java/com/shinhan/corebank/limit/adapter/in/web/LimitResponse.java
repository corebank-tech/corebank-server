...
public record LimitResponse(
        ...
        @Schema(description = "1일 이체한도", example = "5000000")
        long dailyLimit,

        @Schema(description = "당일 사용금액. KST 영업일 기준", example = "300000")
        long dailyUsedAmount,

        @Schema(description = "당일 잔여 이체가능금액. 음수가 되지 않는다", example = "4700000")
