...
public record AutoTransferCancelResult(Long autoTransferId, ProcessResultStatus status,
                                       LocalDateTime terminatedAt, String failureCode, String failureReason) {

    public static AutoTransferCancelResult success(AutoTransfer autoTransfer) {
        return new AutoTransferCancelResult(autoTransfer.getAutoTransferId(), ProcessResultStatus.SUCCESS,
                autoTransfer.getTerminatedAt(), null, null);
    }

    public static AutoTransferCancelResult failure(Long autoTransferId, ErrorCode errorCode) {
        return new AutoTransferCancelResult(autoTransferId, ProcessResultStatus.ERROR,
