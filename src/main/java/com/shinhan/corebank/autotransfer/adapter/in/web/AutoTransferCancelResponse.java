...
public record AutoTransferCancelResponse(
        @Schema(description = "해지 성공·실패 건수 집계") AutoTransferCancelSummaryResponse summary,
        @Schema(description = "요청한 ID 순서(오름차순)대로의 건별 처리결과") List<AutoTransferCancelItemResponse> items) {
