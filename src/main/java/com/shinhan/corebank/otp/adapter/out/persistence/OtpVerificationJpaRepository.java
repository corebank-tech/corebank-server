...
public interface OtpVerificationJpaRepository
        extends JpaRepository<OtpVerificationJpaEntity, String> {
    ...
    @Query("""
            ...
            where request.verificationRequestId = :requestId
              and request.purpose = 'OTP_TRANSACTION'
            """)
    Optional<OtpVerificationJpaEntity> findByIdForUpdate(
    ...
    @Query("""
            ...
            """)
    Optional<OtpVerificationJpaEntity> findVerifiedById(
            @Param("requestId") String requestId
    );
}
