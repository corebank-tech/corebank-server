...
public record VerifyOtpResponse(
        @Schema(description = "최종 거래에서 한 번 사용할 수 있는 OTP 인증 토큰", example = "OTP_AUTH_7xP9qK2RmY5vLw8ZbC6dE4fG1hH0jM3n")
                String otpAuthToken,
        @Schema(description = "성공 응답에서는 null", nullable = true) Integer errorCount,
        @Schema(description = "성공 응답에서는 null", nullable = true) Integer remainingAttempts) {
