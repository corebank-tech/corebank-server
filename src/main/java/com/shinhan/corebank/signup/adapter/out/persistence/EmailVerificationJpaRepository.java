...
public interface EmailVerificationJpaRepository extends JpaRepository<EmailVerificationJpaEntity, String> {
    ...
    @Query(
            ...
            """)
    Optional<EmailVerificationJpaEntity> findByIdForUpdate(@Param("requestId") String requestId);
    ...
    @Query(
            ...
            """)
    int invalidateActiveRequests(@Param("email") String email, @Param("purpose") String purpose);
}
