...
public record AgreedTermRequest(
        @Schema(description = "회원가입 약관 식별자", example = "TERMS_SERVICE") @NotBlank String termsId,
        @Schema(description = "동의한 약관 버전", example = "1.0") @NotBlank String version,
        @Schema(description = "약관 동의 여부", example = "true") boolean isAgreed,
        @Schema(description = "약관 전문 열람 여부", example = "true") boolean isRead) {
