...
public record SignupConfirmationResult(
        String userName, String userId, String birthDate, String phoneNumber, String email) {

    public static SignupConfirmationResult from(SignupConfirmation value) {
        return new SignupConfirmationResult(
                value.userName(), value.userId(), value.birthDate(), value.phoneNumber(), value.email());
    }
}
