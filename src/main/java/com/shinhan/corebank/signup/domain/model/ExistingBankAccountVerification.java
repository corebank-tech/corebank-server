...
public record ExistingBankAccountVerification(
    ...
    public static ExistingBankAccountVerification verified(
            String customerId,
            String accountId
    ) {
        return new ExistingBankAccountVerification(
                ExistingBankAccountVerificationStatus.VERIFIED,
                customerId,
                accountId,
                0,
                MAX_ATTEMPTS
    ...
    public static ExistingBankAccountVerification passwordMismatch(
            int errorCount
    ) {
        return new ExistingBankAccountVerification(
