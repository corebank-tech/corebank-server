...
public record FindIdRequest(
        @Schema(description = "고객명", example = "홍길동", maxLength = 50, requiredMode = Schema.RequiredMode.REQUIRED)
                String customerName,
        @Schema(
    ...
    public FindIdCommand toCommand() {
        return new FindIdCommand(customerName, birthDate, accountNumber, accountPassword);
    }
