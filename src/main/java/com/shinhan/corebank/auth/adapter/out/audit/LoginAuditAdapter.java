...
public class LoginAuditAdapter implements RecordLoginAuditPort {
    ...
    @Override
    public void record(Long customerId, String requestIp, boolean success, LoginAuditReason reason) {
        auditLogService.record(
                customerId, null, AuditEventType.LOGIN, requestIp, success, Map.of("reason", reason.name()));
    }
}
