...
public class FindIdAccountVerificationAdapter
        implements FindIdAccountVerificationPort {
    ...
    public FindIdAccountVerificationResult verify(
        ...
        var result = accountIdentityVerifier.verify(
                new AccountIdentityVerification(
        ...
        return new FindIdAccountVerificationResult(
                FindIdAccountVerificationStatus.valueOf(
                        result.status().name()
                ),
                result.customerId()
        );
