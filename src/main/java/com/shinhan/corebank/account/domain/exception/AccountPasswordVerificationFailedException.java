...
public class AccountPasswordVerificationFailedException extends BusinessException {

    private final AccountPasswordAttemptResult attemptResult;

    public AccountPasswordVerificationFailedException(
            AccountPasswordErrorCode errorCode, AccountPasswordAttemptResult attemptResult) {
        super(errorCode);
