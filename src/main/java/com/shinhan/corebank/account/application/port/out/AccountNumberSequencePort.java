...
public interface AccountNumberSequencePort {
    Optional<AccountNumberSequence> findForUpdate(String bankCode, AccountType accountType, Long productId);

    void update(AccountNumberSequence accountNumberSequence);
}
