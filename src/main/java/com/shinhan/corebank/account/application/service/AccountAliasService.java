...
public class AccountAliasService implements AccountAliasUseCase {
    ...
    @Override
    public AccountAliasResult changeAlias(Long customerId, Long accountId, String alias) {
        ...
        return new AccountAliasResult(savedAccount.getAccountId(), savedAccount.getAlias());
    }

    @Override
    public void deleteAlias(Long customerId, Long accountId) {
        Account account = getOwnedAccount(accountId, customerId);
    ...
    private Account getOwnedAccount(Long accountId, Long customerId) {
