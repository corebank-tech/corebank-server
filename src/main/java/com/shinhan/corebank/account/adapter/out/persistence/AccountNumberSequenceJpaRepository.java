...
public interface AccountNumberSequenceJpaRepository
        extends JpaRepository<AccountNumberSequenceJpaEntity, Long> {
    ...
    @Query("""
        ...
        """)
    Optional<AccountNumberSequenceJpaEntity>
    findDemandDepositForUpdate(
