...
public record AccountAliasResponse(
        ...
        @Schema(description = "설정된 계좌별명", example = "생활비통장") String alias) {

    public static AccountAliasResponse from(AccountAliasResult result) {
        return new AccountAliasResponse(result.accountId(), result.alias());
    }
}
